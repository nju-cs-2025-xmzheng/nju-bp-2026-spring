...
/* Seven arguments */
#define sts_print7(a, b, c, d, e, f, g)                                        \
    do {                                                                       \
        sts_print1(a);                                                         \
        sts_print1(b);                                                         \
        sts_print1(c);                                                         \
...
/* Eight arguments */
#define sts_print8(a, b, c, d, e, f, g, h)                                     \
    do {                                                                       \
        sts_print1(a);                                                         \
        sts_print1(b);                                                         \
        sts_print1(c);                                                         \
...
/* Nine arguments */
#define sts_print9(a, b, c, d, e, f, g, h, i)                                  \
    do {                                                                       \
        sts_print1(a);                                                         \
        sts_print1(b);                                                         \
        sts_print1(c);                                                         \
...
/* Ten arguments */
#define sts_print10(a, b, c, d, e, f, g, h, i, j)                              \
    do {                                                                       \
        sts_print1(a);                                                         \
        sts_print1(b);                                                         \
        sts_print1(c);                                                         \
...
/* Print with newline */
#define sts_println1(x)                                                        \
    do {                                                                       \
        sts_print1(x);                                                         \
        sts_puts("");                                                          \
    } while (0)
#define sts_println2(a, b)                                                     \
    do {                                                                       \
        sts_print2(a, b);                                                      \
        sts_puts("");                                                          \
    } while (0)
#define sts_println3(a, b, c)                                                  \
    do {                                                                       \
        sts_print3(a, b, c);                                                   \
        sts_puts("");                                                          \
    } while (0)
#define sts_println4(a, b, c, d)                                               \
    do {                                                                       \
        sts_print4(a, b, c, d);                                                \
        sts_puts("");                                                          \
    } while (0)
#define sts_println5(a, b, c, d, e)                                            \
    do {                                                                       \
        sts_print5(a, b, c, d, e);                                             \
        sts_puts("");                                                          \
    } while (0)
#define sts_println6(a, b, c, d, e, f)                                         \
    do {                                                                       \
        sts_print6(a, b, c, d, e, f);                                          \
        sts_puts("");                                                          \
    } while (0)
#define sts_println7(a, b, c, d, e, f, g)                                      \
    do {                                                                       \
        sts_print7(a, b, c, d, e, f, g);                                       \
        sts_puts("");                                                          \
    } while (0)
#define sts_println8(a, b, c, d, e, f, g, h)                                   \
    do {                                                                       \
        sts_print8(a, b, c, d, e, f, g, h);                                    \
        sts_puts("");                                                          \
    } while (0)
#define sts_println9(a, b, c, d, e, f, g, h, i)                                \
    do {                                                                       \
        sts_print9(a, b, c, d, e, f, g, h, i);                                 \
        sts_puts("");                                                          \
    } while (0)
#define sts_println10(a, b, c, d, e, f, g, h, i, j)                            \
    do {                                                                       \
        sts_print10(a, b, c, d, e, f, g, h, i, j);                             \
        sts_puts("");                                                          \
    } while (0)

/* sts_print - dispatch based on number of arguments */
#define sts_print_get_macro(_1, _2, _3, _4, _5, _6, _7, _8, _9, _10, NAME,     \
                            ...)                                               \
    NAME
#define sts_print(...)                                                         \
    sts_print_get_macro(__VA_ARGS__, sts_print10, sts_print9, sts_print8,      \
                        sts_print7, sts_print6, sts_print5, sts_print4,        \
                        sts_print3, sts_print2, sts_print1)(__VA_ARGS__)

#define sts_println(...)                                                       \
    sts_print_get_macro(__VA_ARGS__, sts_println10, sts_println9,              \
                        sts_println8, sts_println7, sts_println6,              \
                        sts_println5, sts_println4, sts_println3,              \
                        sts_println2, sts_println1)(__VA_ARGS__)
